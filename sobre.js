...
const textosSobre = {
    ...
    'premio': `Em 2024, Amanda teve a oportunidade de participar de um desafio na Record. Prêmio Conquistado: R$ 10.000,00 (dez mil reais). Uso do Prêmio: Com o valor do prêmio, Amanda abriu sua sala de cursos, separando o espaço de ensino do salão de atendimento. Se for de seu interesse você pode ver o video em que eu ganhei esse prêmio:</br> </br> <iframe width="80%" height="315" style="margin: auto;" src="https://www.youtube.com/embed/x1ZxxjxRbKs?si=pGHFBYUDOBqy46iF" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>`
};
